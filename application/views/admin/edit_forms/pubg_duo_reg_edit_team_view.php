...
<html lang="en-us">
    ...
    <body>
        <div class="center-container pubgbackground">
            ...
            <div class="main">
                 <br> <br>
                <h1 class="w3layouts_head">PUBG Team Edit Form</h1>

                <div class="w3layouts_main_grid">

                    <?php $attributes = array('class' => 'w3_form_post', 'id' => 'regform', 'name' => 'regform', 'onsubmit' => 'return Validate();'); ?>
                     <?php echo form_open_multipart('admin/validation/Pubg_Edit_Validate_Controller/validatePubgTeamEdit', $attributes); ?>
                    ...
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            ...
                            <input type="text" name="ptwoName" placeholder="pubg id name " id="ptwoName" required="" value="<?php echo $pubgid ; ?>" onblur="return ptwoname();">

...
<!--                <h1 class="w3layouts_head">Clash of Clans Registration Form</h1>-->
                ...
                <div class="w3layouts_main_grid">
                  ...
                  <?php echo form_open_multipart('admin/validation/Add_Game_Form_Validate_Controller/validateCocEditReg', $attributes); ?>
                        ...
                        <div class="w3_agileits_main_grid w3l_main_grid">
                            <span class="agileits_grid">
                                ...
                                <input type="text" name="cTag" value="<?php echo $ctag; ?>" placeholder=" Clan Tag" id="cTag" required="" onblur="return ctag();">
        ...
        <script type="text/javascript">
            function Validate()
            {
             ...
             var clanetag =  clanTag();
                 ...
                 if ((name === "" || jname === "" || jnumber === "" || mobile === "" || tEmail === "" || cname === "" || ctag === "" || aname === false || bname === false || mname === false || dname === false || ename === false|| clname === false || clanetag === false ) || (sort == false && long == false))
                {
                    return false;
                }

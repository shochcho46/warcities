...
<html lang="en-us">
    ...
    <body>
        <div class="center-container mlbbbackground">
            ...
            <div class="main">
                 <br> <br>
                <h1 class="w3layouts_head">MBLL Team Edit Form</h1>

                <div class="w3layouts_main_grid">

                    <?php $attributes = array('class' => 'w3_form_post', 'id' => 'regform', 'name' => 'regform', 'onsubmit' => 'return Validate();'); ?>
                     <?php echo form_open_multipart('admin/validation/Pubg_Edit_Validate_Controller/validateMlbbTeamEdit', $attributes); ?>


                    
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            <label>MLBB Id Name </label>
                            <input type="text" name="ptwoName" placeholder="Mlbb id name " id="ptwoName" required="" value="<?php echo $pubgid ; ?>" onblur="return ptwoname();">
    ...
    <script src="<?= base_url() ?>asset/js/cocRegValidation.js" type="text/javascript"></script>
        <script type="text/javascript">
            function Validate()
            {
                ...
                var team = document.getElementById('ptwoName').value;
        
               
               var teamfunction =  ptwoname();

...
<body>
     ...
     <?php foreach ($sub_cotent as $row): ?>
                <?php $gameName = $row['gamename']; ?>
                 <?php $location = $row['piclocation']; ?>
                 
                <?php $id = $row['id']; ?>
    <?php endforeach; ?>
    
    <h1 class="text-center">GAME EDIT FORM</h1>
    <br>
    <?php $attributes = array('id' => 'demo-form2','class' => 'form-horizontal form-label-left', 'name' => 'myform', 'onsubmit' => 'return  validation()'); ?>
        <?php echo form_open_multipart('admin/validation/Add_Game_Form_Validate_Controller/validateEditGameType', $attributes); ?>
    ...
    <!--<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <hr>
                             <img src="<?php echo $location; ?>" id="upimg" width="100px" height="100px">
                        </div>
...
<script type="text/javascript">
    ...
    function validation()
    {
     var name =  document.getElementById("name").value;
       ...
       var imgtype = screenShot();

        if (name === ''|| img === ''|| nametype === false || imgtype === false)
        {

...
<html lang="en-us">
    ...
    <body>
        ...
        <?php foreach ($sub_cotent as $row): ?>
            ...
            <?php $id = $row['id']; ?>
            <?php $locationpic = $row['piclocation']; ?>
        ...
        <?php echo form_open_multipart('admin/validation/Add_Game_Form_Validate_Controller/validateEditeMainGame', $attributes); ?>

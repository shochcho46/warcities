                ...
                <?php $id = $row['id']; ?>
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class="text-center "><?php echo anchor('admin/edit/Admin_Edit_conrtroller/mainTournametListEdit/' . $newtablename . '/' . $id . '', 'EDIT <i class="fa fa-pencil-square-o" aria-hidden="true"></i>', 'class="btn btn-info"'); ?>  &nbsp; 

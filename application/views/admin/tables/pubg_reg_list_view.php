                      ...
                      <?php $payment = $row['playerPaymentSatus']; ?>
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class=" text-center"><?php echo $pubname; ?> </td>
                            <td class=" text-center"><?php echo $pubgNumber; ?> </td>
                            <td class=" text-center"><?php echo $mobile; ?> </td>
                            <td class=" text-center"><?php echo $platfrom; ?> </td>
                            
                            <td class=" text-center"><?php echo $map; ?> </td>
                            ...
                            <td class="text-center "><?php echo anchor('admin/edit/Admin_Edit_conrtroller/pubgListEdit/' . $newtablename . '/' . $id . '', 'EDIT <i class="fa fa-pencil-square-o" aria-hidden="true"></i>', 'class="btn btn-info"'); ?>  &nbsp;

                      ...
                      <?php $payment = $row['playerPaymentSatus']; ?>  
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class=" text-center text-success"><?php echo $payment; ?> </td>
                            
                            <td class="text-center "><?php echo anchor('admin/edit/Admin_Edit_conrtroller/cocListEdit/' . $newtablename . '/' . $id . '', 'EDIT <i class="fa fa-pencil-square-o" aria-hidden="true"></i>', 'class="btn btn-info"'); ?>  &nbsp;
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
            ...
            function resultscreenshot() {
                ...
                if (img === "") {
                    document.getElementById('resulterror').style.color = "red";
                    document.getElementById('resulterror').innerHTML = 'must select a file';
                    return false;
                }
                document.getElementById('resulterror').style.color = "green";
                document.getElementById('resulterror').innerHTML = 'ok';
                return true;
            }
        </script>
    <script type="text/javascript">

...
<body>
    ...
    <br>
    <h1 class="text-center"><?php  echo $Name; ?> TOURNAMENT MESSAGE GAME LIST</h1>
    ...
    <div class="container-fluid">
     ...
     <?php $attributes = array('id' => 'demo-form2', 'class' => 'form-horizontal form-label-left', 'name' => 'myform', 'onsubmit' => 'return  validation()'); ?>
        <?php echo form_open_multipart('admin/Admin_Load_controller/searchSubgameMessage', $attributes); ?>        
                ...
                <?php $person = $row['totalPerson']; ?>
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class="text-center "><?php echo anchor('admin/Admin_Load_controller/addMessage/' . $id . '', 'add <i class="fa fa-plus" aria-hidden="true"></i>', 'class="btn btn-info"'); ?>  &nbsp; 
                                                     <?php echo anchor('admin/edit/Admin_Edit_conrtroller/editAddMessage/' . $id . '', 'show <i class="fa fa-eye"aria-hidden="true"></i>', 'class="btn btn-success"'); ?>  &nbsp; 
                                                     <?php echo anchor('admin/delate/Admin_Erase_conrtroller/delateAnySingelTableDataWithIndex/' . $subtablename . '/' . $id . '', 'delate <i class="fa fa-trash"aria-hidden="true"></i>', 'class="btn btn-danger"'); ?>  &nbsp; 

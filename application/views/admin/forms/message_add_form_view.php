...
<body>
    ...
    <?php $attributes = array('id' => 'demo-form2','class' => 'form-horizontal form-label-left', 'name' => 'myform', 'onsubmit' => 'return  validation()'); ?>
        <?php echo form_open_multipart('admin/validation/Add_Game_Form_Validate_Controller/validateAddMessage', $attributes); ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea rows="12" cols="50" type="text" id="message" name="message" required="required" class="form-control col-md-7 col-xs-12" onblur="messageName()"> </textarea>  <span id="messageError"></span>
                        </div>
                    ...
                    <input class="inputBox" type="hidden" name="subTournameID" value="<?php echo $sub_t_ID; ?>" >
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            ...
                            <input class="btn btn-success" type="submit" id="myBtn"value="Submit">
                        </div>
                      </div>

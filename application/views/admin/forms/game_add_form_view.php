...
<body>
    ...
    <h1 class="text-center">GAME ADD FORM</h1>
    <br>
    <?php $attributes = array('id' => 'demo-form2','class' => 'form-horizontal form-label-left', 'name' => 'myform', 'onsubmit' => 'return  validation()'); ?>
        <?php echo form_open_multipart('admin/validation/Add_Game_Form_Validate_Controller/validateAddGameType', $attributes); ?>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <input type="file" name="image" required=""  id="image" onblur="return screenShot();">
                            ...
                            <hr>
                             <img src="" id="upimg" width="100px" height="100px">
                        </div>

...
<body>
    ...
    <div class="background">
        ...
        <?php $attributes = array('id' => 'myform', 'name' => 'myform', 'onsubmit' => 'return Validate()'); ?>
          <?php echo form_open('Login_Validate_controller/codeValidate', $attributes); ?>
            ...
            <!--<div class="illustration"><i class="icon ion-ios-navigate"></i></div>-->
             ...
             <div class="form-group">
                <input class="form-control" id="code"type="code" name="code" >
             
             </div>
             <p class="text-center">Enter the validation code which is send to your email   </p>
...
<script type="text/javascript">
            function Validate()
            {
                ...
                var tEmail = document.getElementById('code').value;

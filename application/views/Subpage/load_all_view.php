            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-8 col-xs-8 col-lg-8 bodyBOxRight">
                      ...
                      <div class="row text-center">
                        ...
                        <a class="gameitem hvr-float-shadow" role="presentation" href="<?php echo base_url() ?>Call_controller/loadSingelItemAll/<?php echo $id ?>">
...
<!--                                       <heading class="text-uppercase"> Game Name : <?php //echo $newGamename; ?>
                                   ...
                                   <div class="row" >
                                         ...
                                         <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4 text-center">
                                          <a href="<?php echo base_url() ?>Call_controller/details/<?php echo $tid ;?>" class="btn btn-dark hvr-curl-top-right">Details</a>
                                         </div> 
                                       ...
                                       <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4 text-center">
                                          <a href="<?php echo base_url() ?>Call_controller/login" class="btn btn-primary hvr-buzz">Buy</a>
                                         </div>

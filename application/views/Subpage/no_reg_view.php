    ...
    <div style="margin-top: 100px;" class="container-fluid noReg">
        ...
        <div  class="row">
            ...
            <div class="text-center col-md-4 col-sm-4 col-sm-4 col-xs-4">
                <h1>
                  Currently We are <br>Not Hosting any Game Tournament of<br> <b><?= $newNameGame;?></b>
                </h1>    
                 <br> <br>
                 ...
                 <a class="btn btn-dark" href="<?php echo base_url() ?>Call_controller/tournament"><i class="fa fa-trophy fa-1x"></i> TOURNAMENTS</a>

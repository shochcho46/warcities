...
<html lang="en-us">
    ...
    <body>
        <div class="center-container pubgbackground">
            ...
            <div class="main">
                 <br> <br>
                <h1 class="w3layouts_head">PUBG SQUAD REGISTRATION FORM</h1>

                <div class="w3layouts_main_grid">

                    <?php $attributes = array('class' => 'w3_form_post', 'id' => 'regform', 'name' => 'regform', 'onsubmit' => 'return Validate();'); ?>
                    <?php echo form_open_multipart('Pubg_Validation_controller/validatePubgSquadReg', $attributes); ?>
                    ...
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            <label> Player 3 Pubg Id Name </label>
                            <input type="text" name="pthreeName" placeholder=" Pubg Id Name " id="pthreeName" required="" onblur="return pthree();">
                    ...
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            <label> Player 4 Pubg Id Name </label>
                            <input type="text" name="pfourName" placeholder=" Pubg Id Name " id="pfourName" required="" onblur="return pfour();">
...
<!--                            <label> Team </label>
                            ...
                            <input type="hidden" name="team"  id="team" value="SQUAD" value="ERANGEL">
                            <span class="text-center" id="cTagError"></span>
                        </span>
                    </div>
        ...
        <script type="text/javascript">
            function Validate()
            {
              ...
              var playerfourFunction = pfour();
                ...
                if (name === "" || jname === "" || jnumber === "" || mobile === "" || tEmail === "" || cname === "" || ctag === "" || team === "" || playertwo === "" || playerthree === "" || playerfour === "" || aname === false  || mname === false || dname === false || ename === false || cname === false || exitemail === false || teamFunction === false || playertwoFunction === false || playerthreeFunction === false || playerfourFunction === false)
                {

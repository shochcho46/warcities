...
<body>
     <?php foreach ($sub_cotent as $row): ?>
                     <?php $tranid = $row['tranjectionid']; ?>
                      ...
                      <?php $vname = $row['trantype']; ?>
                
      <?php endforeach; ?>  
    <h1 class="text-center">TRANSACTION EDIT FORM</h1>
    <br>
    ...
    <!--<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="tranjectiontype" name="tranjectiontype" placeholder="Bkash,Rocket,Surecash,iPay,Upay,Dmoney ext.." value="<?php echo $vname;?>"required="required" class="form-control col-md-7 col-xs-12" onblur="tranjectiofunType()">  <span id="typeError"></span>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="tranjection" name="tranjection" placeholder="ABCT1234XYZCV" value="<?php echo $tranid;?>" required="required" class="form-control col-md-7 col-xs-12" onblur="tranjectiofun()">  <span id="tranError"></span>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="table" id="table"placeholder="BDT" required="required" value="<?php echo $amount;?>" class="form-control col-md-7 col-xs-12"   onblur="return isMObileNumber();">  <span class="text-center"id="tableError"></span>
                        </div>

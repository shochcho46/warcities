            ...
            <div class="main">
                ...
                <div class="w3layouts_main_grid">
                    ...
                    <?php $attributes = array('class' => 'w3_form_post', 'id' => 'regform', 'name' => 'regform', 'onsubmit' => 'return Validate();'); ?>
                     <?php echo form_open_multipart('reguser/validation/Add_Game_Form_Validate_Controller/validatePubgEditReg', $attributes); ?>
        ...
        <script type="text/javascript">
            function Validate()
            {
               ...
               var aname =  pname();
                ...
                if (name === "" || jname === "" || jnumber === "" || mobile === "" || aname === false || mname === false || dname === false || ename === false)
                {
                    return false;
                }

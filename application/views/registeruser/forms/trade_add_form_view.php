...
<html lang="en-us">
    ...
    <body>
        <div class="center-container tradebackground">
            ...
            <div class="main">
                <h1 class="w3layouts_head">Trade Form</h1>

                <div class="w3layouts_main_grid">

                    <?php $attributes = array('class' => 'w3_form_post', 'id' => 'regform', 'name' => 'regform', 'onsubmit' => 'return Validate();'); ?>
                    <?php echo form_open_multipart('reguser/validation/Add_Game_Form_Validate_Controller/validateTredReg', $attributes); ?>
                    ...
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            ...
                            <input type="text" name="loginId" placeholder="game account email or username" id="loginId" required="" onblur="return log();"><span  class="text-center"id="loginIdError"></span>
                    ...
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            <label> Email </label>
                            <input type="text" name="email" id="email" placeholder=" game account email" required="" onblur="return vEmail();">
                    ...
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            <label> Password </label>
                            <input type="password" name="epassword" id="epassword" placeholder="password" required="" onblur="return checkepassword();">
                    ...
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            <label> Retype Password </label>
                            <input type="password" name="reepassword" id="reepassword" placeholder=" repassword" required="" onblur="return checkreepassword();">
                    ...
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            ...
                            <input type="text" name="sprice" id="sprice"placeholder="BDT" required="" oninput= "getprice.value =parseInt(sprice.value)-(parseInt(sprice.value)*5)/100 "  onblur="return showPrice();">
                   ...
                   <div class="w3_agileits_main_grid w3l_main_grid">
                       <span class="agileits_grid">
                            ...
                            <output id="o" name="getprice" for="sprice" style="color: white;">  </output>
<!--                            <input type="text" name="gprice" id="gprice"placeholder="BDT" required=""   >
                  ...
                  <?php $userId = $this->session->userdata('id');?>
                    ...
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            <label>Heading </label>
                            <input type="text" name="heding" id="heding"placeholder="symple game details" required=""   onblur="return heading();">
                      ...
                      <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            ...
                            <input type="file" name="image[]"multiple="multiple" required="" multiple id="gallery-photo-add" onblur="return screenShot();">
                  ...
                  <h3 class="text-center">Detail Description </h3>
                    ...
                    <input class="inputBox" type="hidden" name="gameId" value="<?php echo $gameId; ?>" >
                    <input class="inputBox" type="hidden" name="itemName" value="<?php echo $itemName; ?>" >
                   <input class="inputBox" type="hidden" name="itemId" value="<?php echo $itemId; ?>" >
                    <input class="inputBox" type="hidden" name="userId" value="<?php echo $userId; ?>" >    
                   <input class="inputBox" type="hidden" name="userName" value="<?php echo $userName; ?>" >
                ...
                <div class="row">
				 ...
				 <span class="agileits_grid">
                            ...
                            <textarea type="text" name="content" class="ckeditor" id="editor"placeholder="" required=""   onblur="return textedti();"></textarea>

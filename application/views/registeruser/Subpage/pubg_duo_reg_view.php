        ...
        <div class="center-container pubgbackground">
            ...
            <div class="main">
                ...
                <div class="w3layouts_main_grid">
                    ...
                    <?php echo form_open_multipart('reguser/validation/Pubg_Validation_controller/validatePubgReg', $attributes); ?>
        ...
        <script type="text/javascript">
            function Validate()
            {
              ...
              var playertwoFunction = ptwoname();
                ...
                if ( jname === "" || jnumber === ""  || team === ""  || playertwo === ""  || mname === false || ename === false || teamFunction === false || playertwoFunction === false )
                {
                    return false;
                }

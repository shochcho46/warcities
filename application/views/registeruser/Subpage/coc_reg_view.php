        ...
        <div class="center-container cocbackground">
            ...
            <div class="main">
                ...
                <div class="w3layouts_main_grid">
                    ...
                    <?php echo form_open_multipart('reguser/validation/Add_Game_Form_Validate_Controller/validateregCocReg', $attributes); ?>
        ...
        <script type="text/javascript">
            function Validate()
            {
             ...
             var clanetag =  clanTag();
                ...
                if (( jname === "" || jnumber === ""  || cname === "" || ctag === ""|| mname === false || ename === false|| clname === false || clanetag === false) || (sort == false && long == false))
                {
                    return false;
                }

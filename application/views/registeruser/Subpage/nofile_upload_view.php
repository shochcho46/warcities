...
<body>
    ...
    <div class="container">
        ...
        <div class="text-center">
            <figure class="figure">
                 <img class="img-thumbnail"src="<?= base_url()?>asset/image/Background_image/homepage/filenotfound.png" alt=""/>
                  <figcaption class="figure-caption">No File Uploaded...</figcaption>
            </figure>

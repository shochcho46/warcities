                ...
                <?php $id = $row['id']; ?>
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class="text-center "><?php echo anchor('admin/edit/Admin_Edit_conrtroller/tournametListEdit/' . $newtablename . '/' . $id . '', 'EDIT <i class="fa fa-pencil-square-o" aria-hidden="true"></i>', 'class="btn btn-info"'); ?>  &nbsp;  <?php echo anchor('admin/Admin_Load_controller/tournametListAactivate/' . $newtablename . '/' . $id . '', 'ACTIVE', 'class="btn btn-success"'); ?>  &nbsp; <?php echo anchor('admin/Admin_Load_controller/tournametListDeactivate/' . $newtablename . '/' . $id . '', 'DISABLE ', 'class="btn btn-default"'); ?>  &nbsp; <?php echo anchor('admin/delate/Admin_Erase_Conrtroller/delateTournamentGame/' . $newtablename . '/' . $id . '', 'DELETE <i class="fa fa-trash" aria-hidden="true"></i>', 'class="btn btn-danger"'); ?> </td>

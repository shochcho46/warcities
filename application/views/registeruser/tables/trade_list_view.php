...
<body>
    ...
    <br>
    <h1 class="text-center"> UNSOLD TRADE LIST</h1>
    <br>
        ...
        <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title text-center">SHOW PRICE</th>
                 ...
                 <?php $gameName = str_replace("%20"," ",$Name); ?>
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class=" text-center "><?php echo $showprice; ?> </td>
                            <td class=" text-center "><?php echo $getprice; ?> </td>
                            <td class=" text-center "><?php echo $status; ?> </td>
                            
                            <td class="text-center "><?php echo anchor('reguser/edit/RegUser_Edit_conrtroller/editTradeInfo/' . $newtablename . '/' . $id . '', 'EDIT <i class="fa fa-pencil-square-o" aria-hidden="true"></i>', 'class="btn btn-info"'); ?> &nbsp; <?php echo anchor('admin/delate/Admin_Erase_Conrtroller/delateAnyTradeData/' . $newtablename . '/' . $id . '', 'DELETE <i class="fa fa-trash" aria-hidden="true"></i>', 'class="btn btn-danger"'); ?> </td>

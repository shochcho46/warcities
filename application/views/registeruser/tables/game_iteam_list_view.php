                ...
                <?php $id = $row['id']; ?>
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class=" text-center "><img class="img-thumbnail" style="height: 100px; width: 100px;" src="<?php echo $location; ?>" alt="NO IMAGE UPLOADED"/></td>
                        
                            <td class="text-center "><?php echo anchor('admin/edit/Admin_Edit_conrtroller/gameListEdit/' . $newtablename . '/' . $id . '', 'EDIT <i class="fa fa-pencil-square-o" aria-hidden="true"></i>', 'class="btn btn-info"'); ?> &nbsp; <?php echo anchor('admin/delate/Admin_Erase_Conrtroller/delateTournamentGame/' . $newtablename . '/' . $id . '', 'DELETE <i class="fa fa-trash" aria-hidden="true"></i>', 'class="btn btn-danger"'); ?> </td>
